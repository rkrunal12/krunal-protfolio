            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            ...
                            <div className="space-y-8">
                                <div className="flex items-center gap-6 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xl font-bold text-white group-hover:text-primary-400 transition-colors">krunalrathod278@gmail.com</p>
                                    </div>
                                </div>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <form className="glass-card p-10 space-y-6 border-white/5 relative overflow-hidden group">
                            ...
                            <button className="btn-primary w-full relative z-10 flex items-center justify-center gap-3">
